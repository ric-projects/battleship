...
// function attack(x, y, player, DOMboard) {
...
// placeShip(3, 4, 2, player1, p1Board);
// placeShip(2, 5, 3, player2, p2Board);
// placeShip(7, 9, 5, player1, p1Board);
// placeShip(1, 2, 4, player2, p2Board);

// attack(2, 5, player2, p2Board);
// attack(3, 3, player1, p1Board);
